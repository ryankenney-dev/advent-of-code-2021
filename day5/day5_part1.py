...
def filter_out_diagonal_lines(lines: List[Line]) -> List[Line]:
    non_diagonal_lines: List[Line] = []
    for line in lines:
        if line[0]['row'] == line[1]['row'] or line[0]['col'] == line[1]['col']:
            non_diagonal_lines.append(line)
